...
<main>
	...
	<div class="right-container">
		<div class="dropdown-container" title="Select your dance mode">
			<Dropdown
				options={group_modes_titles}
				selectedOption={selected_group_mode}
...
<style lang="scss">
	...
	div.left-container div.tag {
		...
		font-size: 12px;
		user-select: none;
		background: linear-gradient(45deg, var(--color-green-dark) 0%, var(--color-green-light) 100%);
		border-radius: 6px;
		padding: 3px;
		padding-left: 6px;
		padding-right: 6px;
