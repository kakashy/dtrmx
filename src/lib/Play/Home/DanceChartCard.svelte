	...
	<div class="bottom-section">
		...
		<div class="bottom-grid">
			<div class="left-side">
				...
				<div class="plays-and-publish-time">
					{card_data.plays || 0} plays · {GetRelativeTimeFormat(card_data.last_edited)}
				</div>
			</div>
...
<style lang="scss">
	...
	div.card {
		...
		--shadow-elevation-medium: 0px 0px 1px hsl(var(--shadow-color) / 0.36),
		...
		--shadow-elevation-high: 0.3px 0.3px 0.5px hsl(var(--shadow-color) / 0.32),
