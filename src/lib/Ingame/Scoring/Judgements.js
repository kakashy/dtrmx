...
export const JUDGEMENT_CUTOFFS = {
	...
	[JUDGEMENTS.MARVELOUS]: 0.9,
	[JUDGEMENTS.GREAT]: 0.8,
	[JUDGEMENTS.GOOD]: 0.7,
	[JUDGEMENTS.ALMOST]: 0.6,
	[JUDGEMENTS.MISS]: 0.0
};
...
export const GetCurrentTopJudgementFromPastPeriodWithoutOutliers = (
	all_judgements,
	currentTime
) => {
...
export const GetScoringDurationFromInOutScoringAreas = (duration, _in, _out, scoring_areas) => {
