...
<main in:fade>
	<div class="container">
		...
		<h2 in:fly={{ delay: 1000, y: 30, duration: 800 }}>
			{#if !submitted}
				Got an invitation? Enter your email below and we'll send you a magic link to login.
			{:else}
	...
	<h3 in:fly={{ delay: 8000, y: -30, duration: 1500 }}>
		Don't have an invitation?<br /><a href="https://forms.gle/nxfAB56nTarZ18MP9" target="_blank"
			>Apply here for an invite.</a
		>
	</h3>
</main>
