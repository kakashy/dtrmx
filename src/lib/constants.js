...
export const MODES = [
	{
		title: 'Create',
		state: MODE_STATE.CREATE,
		colors: ['var(--color-yellow-dark)', 'var(--color-yellow-light)']
	},
	{
		title: 'Play',
		state: MODE_STATE.PLAY,
		colors: ['var(--color-pink-dark)', 'var(--color-pink-light)']
	}
];
export const GROUP_MODES = {
	[GROUP_STATE.SOLO]: {
		title: 'Solo',
		state: GROUP_STATE.SOLO,
		colors: ['var(--color-red-dark)', 'var(--color-red-light)']
	},
	[GROUP_STATE.COUPLE]: {
		title: 'Couple',
		state: GROUP_STATE.COUPLE,
		colors: ['var(--color-turquoise-dark)', 'var(--color-turquoise-light)']
	}
...
export const COMPONENT_DATA = {
	...
	[COMPONENT_TYPE.VIDEO_IN_OUT_POINTS]: {
		name: 'Video In/Out Points',
		limit: 1,
		get_default_data: (project) => {
			return {
				in: 0,
...
export const SONG_WHEEL_CATEGORY_INFO = {
	[SONG_WHEEL_CATEGORIES.PLAYLISTS]: {
		title: 'Playlists',
		colors: ['var(--color-pink-dark)', 'var(--color-pink-light)']
	},
	[SONG_WHEEL_CATEGORIES.NEWEST]: {
		title: 'Newest',
		colors: ['var(--color-turquoise-dark)', 'var(--color-turquoise-light)']
	},
	[SONG_WHEEL_CATEGORIES.HOT]: {
		title: 'Hot',
		colors: ['var(--color-yellow-dark)', 'var(--color-yellow-light)']
	},
	[SONG_WHEEL_CATEGORIES.POPULAR]: {
		title: 'Popular',
		colors: ['var(--color-pink-dark)', 'var(--color-pink-light)']
	},
	[SONG_WHEEL_CATEGORIES.FAVORITES]: {
		title: 'Favorites',
		colors: ['var(--color-blue-dark)', 'var(--color-blue-light)']
	},
	[SONG_WHEEL_CATEGORIES.RECENT]: {
		title: 'Recent',
		colors: ['var(--color-purple-dark)', 'var(--color-purple-light)']
	}
};
